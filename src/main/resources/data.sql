...
insert into account
    (account_id, fk_customer_id, balance, account_number, card_number, start_date)
values (1, 10002, 5000, 'NL90INGB123450000', 1234, NOW());

insert into account
    (account_id, fk_customer_id, balance, account_number, card_number, start_date)
values (2, 10002, 5000, 'NL90INGB123452222', 1234, NOW();

insert into account
    (account_id, fk_customer_id, balance, account_number, card_number, start_date)
values (3, 10002, 5000, 'NL90INGB123456678', 1234, NOW());

insert into account
    (account_id, fk_customer_id, balance, account_number, card_number, start_date)
values (4, 10005, 5000, 'NL90INGB123459999', 1234, NOW());

insert into account
    (account_id, fk_customer_id, balance, account_number, card_number, start_date)
values (5, 10006, 5000, 'NL90INGB123456888', 1234, NOW());
